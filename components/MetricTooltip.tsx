export default function MetricTooltip({ content }: { content: string }) {
  return (
    <div className="relative group inline-block">
      ...
      <div className="pointer-events-none group-hover:pointer-events-auto opacity-0 group-hover:opacity-100 transition-opacity duration-150 absolute bottom-full right-0 mb-2 w-64 max-w-[min(16rem,calc(100vw-2rem))] p-3 rounded-lg bg-neutral-800 border border-neutral-700 text-xs text-neutral-300 leading-relaxed z-20 shadow-xl">
        {content}
        <div className="absolute top-full right-1.5 w-0 h-0 border-l-[5px] border-r-[5px] border-t-[5px] border-l-transparent border-r-transparent border-t-neutral-700" />
      </div>
    </div>
  );
}
